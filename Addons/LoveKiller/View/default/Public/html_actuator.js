...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if(window.my_list){
    ...
    if(inner.textContent.substring(0,8)=='./Addons'){
...
HTMLActuator.prototype.message = function (won, score) {
  ...
  //Adaption Close
  var best = parseInt(this.bestContainer.lastChild.data);
  if(this.score >= best && !islogh){	
	islogh = true;
	$.ajax({type: 'GET',url: hh,data:{hhf:best},dataType: 'json',cache: false,error: function() {},success: function(json) {islogh=false;}});  
  }
