...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/wp2/index.php?s=/Admin/Menu/index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            //导航高亮
            $('.side-sub-menu').find('a[href="<?php echo U('index');?>"]').closest('li').addClass('current');
            //点击排序
