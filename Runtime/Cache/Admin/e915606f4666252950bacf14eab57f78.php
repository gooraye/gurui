...
<body>
   ...
   <div class="main-title">
        ...
        <div id="update_remind" style="clear:both; margin-bottom:10px;border:1px solid #33ab07; padding:10px; background-color:#d8f9cc; color:#33ab07; position:relative; display:none">
        	<a href="<?php echo U('update/index');?>">出升级包了，请及时升级！</a>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?><div class="form-item">
			<label class="item-label"><?php echo ($config["title"]); if(!empty($config['remark'])): ?><span class="check-tips">（<?php echo ($config["remark"]); ?>）</span><?php endif; ?> </label>
			<div class="controls">
