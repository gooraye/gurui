...
<link href="/wp2/Public/static/font-awesome/css/font-awesome.min.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wp2/Public/Home/css/base.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wp2/Public/Home/css/module.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wp2/Public/Home/css/weiphp.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/wp2/Public/static/bootstrap/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
<![endif]-->

<!--[if lt IE 9]>
<script type="text/javascript" src="/wp2/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
...
<script type="text/javascript" src="/wp2/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
       <a class="brand" title="<?php echo C('WEB_SITE_TITLE');?>" href="<?php echo U('index/index');?>"><img src="/wp2/Public/Home/images/top_logo.png?v=<?php echo SITE_VERSION;?>" title="<?php echo C('WEB_SITE_TITLE');?>"/></a>
                    ...
                    <div class="controls">
                      <?php switch($field["type"]): case "num": ?><input type="number" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                        ...
                        <?php case "checkbox": $_result=parse_field_attr($field['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="check-item">
                             <input type="checkbox" value="<?php echo ($key); ?>" class="regular_checkbox" id="<?php echo ($field["name"]); ?>_<?php echo ($key); ?>" name="<?php echo ($field["name"]); ?>[]" 
                        ...
                        <?php case "picture": ?><div class="controls uploadrow" title="点击修改图片">
                            ...
                            <div class="upload-img-box">
                              <?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item">
                                  
                                  <img width="120" height="120" src="<?php echo (get_cover_url($data[$field['name']])); ?>"/></div><?php endif; ?>
                            </div>
                          </div>
                          ...
                          <script type="text/javascript">
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 120,
							        "swf"             : "/wp2/Public/static/uploadify/uploadify.swf",
                        ...
                        <?php case "file": ?><div class="controls uploadrow" title="点击修改">
...
if(weixin_cover_picurl==undefined || weixin_cover_picurl==""){
	$('.weixin-cover-pic').attr('src',"/wp2/Public/Home/images/no_cover.png");
}else{
...
<footer class="footer">
      <div class="container">
          <p>
            ...
            <a href="http://www.miitbeian.gov.cn" target="_blank"><?php echo C('WEB_SITE_ICP');?></a>
            </p>
      </div>
</footer>
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/wp2", //当前网站地址
		"APP"    : "/wp2/index.php?s=", //当前项目地址
		"PUBLIC" : "/wp2/Public", //项目公共目录地址
...
<link href="/wp2/Public/static/datetimepicker/css/datetimepicker.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '
<link href="/wp2/Public/static/datetimepicker/css/datetimepicker_blue.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
'; ?>
<link href="/wp2/Public/static/datetimepicker/css/dropdown.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/wp2/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script> 
<script type="text/javascript" src="/wp2/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script> 
<script type="text/javascript">
