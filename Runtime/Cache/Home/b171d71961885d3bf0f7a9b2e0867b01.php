...
<div class="login_top_btn">
      <a class="btn" href="<?php echo U('User/register');?>">新用户注册</a> 
      <a class="btn" href="<?php echo U('admin/index/index');?>" target="_blank">后台管理</a>
      <a class="btn" href="http://www.weiphp.cn/wiki" target="_blank">二次开发教程</a>
      <a class="btn" href="http://bbs.weiphp.cn" target="_blank">官方论坛</a>
</div>
<section class="login_box">
	<form class="login-form" action="/wp2/index.php?s=/home/user/login.html" method="post">
    	<a href="http://www.gooraye.net">
       		<div class="logo_icon"></div>
       		<div class="logo_text">登陆</div>
    	</a>
